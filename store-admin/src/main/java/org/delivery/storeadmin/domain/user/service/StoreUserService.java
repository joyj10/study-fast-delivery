...
import static org.delivery.db.storeuser.enums.StoreUserStatus.REGISTERED;
...
public class StoreUserService {
    ...
    public StoreUserEntity register(StoreUserEntity storeUserEntity) {
        storeUserEntity.setStatus(REGISTERED);
    ...
    public Optional<StoreUserEntity> getRegisterUser(String email) {
        return storeUserRepository.findFirstByEmailAndStatusOrderByIdDesc(email, REGISTERED);
    }
}
